...
import { removeFromCart } from "@/redux/nahidSlice";
    ...
    <div className="flex py-6 sm:py-10">
      ...
      >
        <Image
          ...
          width={300}
          height={300}
          className="h-full w-full rounded-md object-contain bg-[#f7f7f7]"
        />
      </Link>
      {/* Details */}
      ...
      <div className="ml-4 sm:ml-6 flex flex-1 flex-col justify-between">
        <div className="relative pr-9 sm:grid sm:grid-cols-4 sm:pr-0">
          <div className="flex flex-col gap-1 col-span-5">
            ...
            <p className="text-xs">
              Brnd: <span className="font-medium">{product?.brand}</span>
            </p>
            <p className="text-xs">
          ...
          <div className="mt-4 sm:mt-0 sm:pr-9">
            <div className="absolute top-0 right-0">
              <button
                ...
                className="p-2 text-gray-800 bg-gray-50 
        ...
        <div>
          {product?.availabilityStatus && (
            <p className="flex text-sm space-x-2 text-gray-700">
